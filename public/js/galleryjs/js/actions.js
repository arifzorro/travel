$(document).ready(function(){        
    ...
    $(".gallery-item-remove").on("click",function(){
        $(this).parents(".gallery-item").fadeOut(400,function(){
            ...
            var id=$(".gallery-item-remove").attr("rel");
            var userid=$(".gallery-item-remove").attr("userid");
            //send parameter id from javasqript/jquery to php
    ...
    $(".deletepic").on("click",function (){
        ...
        count=0;
//        $(".gallery-item").each(function(){
             var wr = $(".gallery-item").find(".icheckbox_minimal-grey"); 
             //print object property
//             alert(JSON.stringify(wr,null,4));
//                printobject(wr);
           console.log(wr);
           $(wr).each(function(){
                if($(this).hasClass("checked")){
                  id[count]=$(this).parent().parent().parent().parent().parent().find(".gallery-item-remove").attr("rel");
                  console.log($(this).parent().parent().parent().parent().parent().remove());
                  count++;
                }
           });
           //pass arrayb in javascript
...
//                }
//                if(wr.hasClass("checked")){
//                    data=wr.parent().find(".gallery-item-remove").attr("rel");
//                    alert(data);
//                }
//                else{
//                    alert("no checked");
...
//                 $.ajax({
//                    type: "POST",
//                    url: "<?php echo URL?>uploade/deleteall",
//                    data: data
//                })
//                 $(this).remove();
//             }
//             else{
//                 alert("belum di check");
//             }
//        });
